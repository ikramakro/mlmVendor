...
import '../../global_widgets/custome_image_field_widget.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Obx(() {
                  return CustomImagesFieldWidget(
                    label: "Images".tr,
                    field: 'image',
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          if (!controller.eService.value.hasData)
                            MaterialButton(
                              onPressed: () async {
                                controller.eService.value.priceUnit == "fixed";
                                  ...
                                  builder: (BuildContext context) {
                                    return SingleSelectDialog(
                                      ...
                                      initialSelectedValues:
                                          controller.Subcategories.where(
                                        (category) =>
                                ...
                                print(
                                    "subCategories are ${controller.Subcategories}");
                                print(
                                    "store eservice cat are ${controller.eService.value.categories}");
                                controller.eService.update((val) {
                ...
                Row(
                  ...
                  children: [
                    ...
                    //                   value: "hourly",
                    //                   groupValue:
                    //                       controller.eService.value.priceUnit,
                    //                   selected:
                    //                       controller.eService.value.priceUnit ==
                    //                           "hourly",
