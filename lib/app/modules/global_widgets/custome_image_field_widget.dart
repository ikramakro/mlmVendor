...
class CustomImagesFieldController extends GetxController {
...
class CustomImagesFieldWidget extends StatelessWidget {
  CustomImagesFieldWidget({
    Key key,
    @required this.label,
    @required this.tag,
    @required this.field,
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(CustomImagesFieldController(), tag: tag);
    return Container(
            ...
            children: [
              ...
              MaterialButton(
                onPressed: () async {
                  ...
                  controller.uploaded.value = false;
                },
                shape: StadiumBorder(),
                color: Get.theme.focusColor.withOpacity(0.1),
