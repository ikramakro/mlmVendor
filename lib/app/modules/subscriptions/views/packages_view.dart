      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Text("Select the service provider".tr, style: Get.textTheme.caption)
                .paddingOnly(top: 5),
            Obx(() {
              if (controller.eProviders.length > 1)
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                builder: (BuildContext context) {
                                  return SelectDialog(
                                    ...
                                    initialSelectedValue:
                                      ...
                                      (element) =>
                                          element.id ==
                                          controller.eProviderSubscription.value
                                              .eProvider?.id,
                      ...
                      Obx(() {
                        if (controller.eProviderSubscription.value?.eProvider ==
                            null) {
                          return Padding(
                ...
                controller.eProviderSubscription.value.eProvider =
                    ...
                    onTap: (subscriptionPackage) async {
                      if (controller.eProviderSubscription.value.eProvider ==
                        ...
                        Get.showSnackbar(Ui.defaultSnackBar(
                            message: "Please Select a Service Provider!".tr));
                      } else {
                        controller.eProviderSubscription.update((val) {
                        ...
                        await Get.offAndToNamed(Routes.CHECKOUT,
                            arguments: controller.eProviderSubscription.value);
                      }
                    },
                  );
                },
  ...
  Widget buildProvider(EProviderSubscription _eProviderSubscription) {
    return Padding(
      ...
      child: Container(
        ...
        child: Text(_eProviderSubscription.eProvider?.name ?? '',
