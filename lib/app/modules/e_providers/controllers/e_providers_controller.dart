...
class EProvidersController extends GetxController {
    ...
    try {
      ...
      switch (filter) {
        case EProviderFilter.ALL:
          _eProviders =
              await _eProviderRepository.getEProviders(page: this.page.value);
          break;
        ...
        case EProviderFilter.FEATURED:
          _eProviders = await _eProviderRepository.getFeaturedEProviders(
              page: this.page.value);
          break;
        case EProviderFilter.PENDING:
          _eProviders = await _eProviderRepository.getPendingEProviders(
              page: this.page.value);
          break;
        default:
          _eProviders =
  ...
  void deleteEProvider(EProvider eProvider) async {
    try {
      ...
      Get.showSnackbar(Ui.SuccessSnackBar(
          message: eProvider.name + " " + "has been removed".tr));
    } catch (e) {
      Get.showSnackbar(Ui.ErrorSnackBar(message: e.toString()));
    }
  }
