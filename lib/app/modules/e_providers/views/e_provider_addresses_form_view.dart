  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: Obx(
          () => controller.eProvider.value?.addresses.length < 1
              ? FloatingActionButton(
                  child: new Icon(Icons.add,
                      size: 32, color: Get.theme.primaryColor),
                  onPressed: () => {
                    Get.toNamed(Routes.E_PROVIDER_ADDRESS_PICKER, arguments: {
                      'address': new Address(),
                      'allAddress': controller.addresses
                    })
                  },
        ...
        body: ListView(
          ...
          children: [
            ...
            Text("Addresses details".tr, style: Get.textTheme.headline5)
                .paddingOnly(top: 25, bottom: 0, right: 22, left: 22),
            Text("Select from your addresses".tr, style: Get.textTheme.caption)
                    ...
                    : Column(
                        children: [
                          ClipRRect(
                            ...
                            child: MapsUtil.getStaticMaps(controller
