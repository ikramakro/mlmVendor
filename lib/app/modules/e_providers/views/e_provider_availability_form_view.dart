...
class EProviderAvailabilityFormView
        ...
        body: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              Text("Select your addresses".tr, style: Get.textTheme.caption)
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      var _data = controller.eProvider.value
                          .getAvailabilityHoursData(_availabilityHour.key);
                    ...
                    Row(
                      children: [
                        ...
                        MaterialButton(
                              ...
                              builder: (BuildContext context) {
                                return SelectDialog(
                                  ...
                                  initialSelectedValue:
                                    ...
                                    (element) =>
                                        element ==
                                        controller.availabilityHour.value.day,
                                    orElse: () => "",
                                  ),
                                );
                              },
                          ...
                          child:
                              Text("Select".tr, style: Get.textTheme.subtitle1),
                          elevation: 0,
                          hoverElevation: 0,
                          focusElevation: 0,
