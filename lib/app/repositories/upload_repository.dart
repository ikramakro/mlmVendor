...
class UploadRepository {
  ...
  Future<String> imageReference(File image, String field) {
    return _laravelApiClient.uploadReferenceImage(image, field);
  }
  ...
  Future<bool> deleteOne(String uuids) {
    return _laravelApiClient.deleteOneUploaded(uuids);
  }
}
